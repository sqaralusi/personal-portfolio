document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateDateTime() {
        ...
        const timeString = `${hours}:${minutes} ${ampm}`; // No extra spaces
        const location = "Dallas, TX |"; // Ensure there's no trailing space
    
        document.querySelector('#time').textContent = `${location} ${timeString}`;
    }
